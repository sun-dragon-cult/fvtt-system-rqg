...
- RQG rules formulas/thresholds: when implementing or verifying a game mechanic, cite the specific page and book of the actual rulebook (e.g. "Core p.144" or "RBM1 p.107") rather than relying on memory. Core = *RuneQuest: Roleplaying in Glorantha* (2nd printing); RBM1 = *Red Book of Magic* (supersedes Core on magic rules where the two disagree).
