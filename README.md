...
[![GitHub Release](https://img.shields.io/github/release/sun-dragon-cult/fvtt-system-rqg)](https://github.com/sun-dragon-cult/fvtt-system-rqg/releases/latest)
...
Effects with a duration (like protection spells) automatically expire during combat, tracked by combat rounds. Outside of combat, expiry is instead tracked by elapsed game time - this only advances if something is actively advancing it, so you'll need a module such as a calendar (e.g. [Calendaria](https://foundryvtt.com/packages/calendaria)) that ticks world time forward between sessions/scenes.
...
Written in typescript with the help of the fantastic [League of Foundry Developers Foundry VTT Types](https://github.com/League-of-Foundry-Developers/foundry-vtt-types).
...
The most common types of commits are additions of new features: `feat: add quantity to all items`
...
5. Add Release notes: "See release notes https://sun-dragon-cult.github.io/release-notes/rqg-v7.3.2"
