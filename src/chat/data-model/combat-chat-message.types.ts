import type { weaponDesignation } from "./combat-chat-message.defs";
import type { attackState } from "./combat-chat-message.defs";
import type { CombatManeuver, UsageType } from "@item-model/weapon-data-model.ts";
