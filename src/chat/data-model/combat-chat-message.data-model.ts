import { attackState, weaponDesignation } from "./combat-chat-message.defs.ts";
import { enumChoices } from "../../data-model/shared/enum-choices";
import { chatCombatManeuverSchemaField } from "../../data-model/shared/combat-maneuver-schema-field";
import { weaponUsageChoices } from "../../data-model/shared/weapon-usage-choices";
