...
import { ItemTypeEnum, type RqgItemType } from "@item-model/item-types.ts";
import { armorLifecycle } from "./armor-item/armor-lifecycle";
import { cultLifecycle } from "./cult-item/cult-lifecycle";
import { gearLifecycle } from "./gear-item/gear-lifecycle";
import { hitLocationLifecycle } from "./hit-location-item/hit-location-lifecycle";
import { runeLifecycle } from "./rune-item/rune-lifecycle";
import { runeMagicLifecycle } from "./rune-magic-item/rune-magic-lifecycle";
import { skillLifecycle } from "./skill-item/skill-lifecycle";
import { weaponLifecycle } from "./weapon-item/weapon-lifecycle";
