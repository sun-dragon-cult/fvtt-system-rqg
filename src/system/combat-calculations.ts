import type { AttackDamages, CombatOutcome } from "./combat-calculations.types.ts";
...
import { attackParryMap } from "./attack-parry-table";
...
} from "./combat-calculations.defs";
import { attackDodgeMap } from "./attack-dodge-table";
