...
import { calculateAbilitySuccessLevel } from "./calculate-ability-success-level";
...
describe("Evaluate Ability Roll Success Levels", () => {
  ...
  describe.each`
    ...
    ${9999}      | ${96}  | ${AbilitySuccessLevelEnum.Failure}
    ${9999}      | ${100} | ${AbilitySuccessLevelEnum.Fumble}
