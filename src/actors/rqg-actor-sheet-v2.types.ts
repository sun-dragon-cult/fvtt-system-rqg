import type { SheetRuneData, MainCult, UiSections, CurrencyTotals } from "./rqg-actor-sheet.types";
import type { RuneOpposedPair } from "./rqg-actor-sheet-data-prep";
...
export interface RqgActorSheetV2Context {
  ...
  isEditable: boolean;
  isEmbedded: boolean;
  /** Active tab ids rendered into templates for native data-action=tab handling. */
  activeTabs: {
    primary: string;
    gearView: string;
    cultView?: string;
